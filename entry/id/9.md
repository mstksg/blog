...
mean…it’s the study of how things move under forces. How can you get any deeper
...
like this: Every object “wants” to go *downwards* in a potential field — it will
want to go in the direction (backwards/forwards for the roller coaster,
...
Then, they invented the equivalent of an $F = m a$ for this abstract state — an
...
action…but that’s just slightly less likely. It *probably did not* take the path
